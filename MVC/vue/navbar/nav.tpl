...
<nav id="navPc">
    <ul class="nav-list">
        ...
        if(isset($_SESSION['status']) && ($_SESSION['status'] == "admin" || $_SESSION['status'] == "gestionnaire") ) {
            echo("<li><a href='./?path=pages/ajoutfilm'><i class='fa-solid fa-plus'></i> Film</a></li> <li><a href='./?path=pages/ajoutcinema'><i class='fa-solid fa-plus'></i> Cinema</a></li> <li><a href='./?path=pages/ajoutseance'><i class='fa-solid fa-plus'></i> Séance</a></li> <li><a href='./?path=pages/users'>Users</a></li>");
        }
        ?>
        <?php
